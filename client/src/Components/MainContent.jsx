        ...
        <div className="Top__content">
          <div className="main__content">
            ...
            <div className="content__text">
              <h5>
               READY TO OCCUPY PROPERTIES ON SALE STARTING FROM 32 LACKS ONWARDS.
              </h5>
      ...
      <div className="CenterContent__container hideForMobile">
        ...
        <div className="Top__content">
          <div className="main__content">
            ...
            <div className="content__text">
              <h5>
                RENTING PROPERTIES FOR LONG AND SHORT DURATIONS NOW EASIER AND FASTER .PRICES STARTING AT 30K PER MONTH.
              </h5>
      ...
      <div className="BottomContent__container">
        ...
        <div className="Top__content">
          <div className="main__content">
            ...
            <div className="content__text">
              <h5>
                EASILY REACH US OUT HERE TO BUY OR RENT PROPERTIES AT CHEAP PRICES.
              </h5>
              <Link to="/contact-us">
                <button>CHECK IT OUT</button>
              </Link>
